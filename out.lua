...
Main = (function()
	...
	Main.Init = function()
		...
		if Main.Elevated then
			...
			Main.ClientVersion = (function() local genv=getgenv(); local fn=genv["Version"]; if type(fn)=="function" then local ok,v=pcall(fn); if ok then return v end end; local ie=genv["identifyexecutor"]; if type(ie)=="function" then local ok,v=pcall(ie); if ok then return v end end; return "0.0.0.0" end)()
			if fileVer then
