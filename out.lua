...
Main = (function()
	...
	Main.InitEnv = function()
		...
		env.readfile   = rawget(_G,"readfile")
		env.writefile  = rawget(_G,"writefile")
		env.appendfile = rawget(_G,"appendfile")
		env.makefolder = rawget(_G,"makefolder")
		env.listfiles  = rawget(_G,"listfiles")
		env.loadfile   = rawget(_G,"loadfile")
		env.saveinstance = rawget(_G,"saveinstance")
		local dbg = rawget(_G,"debug") or {}
		env.getupvalues  = (type(dbg)=="table" and dbg.getupvalues) or rawget(_G,"getupvals")
		env.getconstants = (type(dbg)=="table" and dbg.getconstants) or rawget(_G,"getconsts")
		...
		env.setclipboard = rawget(_G,"setclipboard")
		...
		local ie = rawget(_G,"identifyexecutor")
